...
\problem{att} the set of all periods of a given word is closed under gcd.
$$\alpha,\beta\in \SET{periods}(\VAR{word})\implies \FNC{gcd}(\alpha,\beta)\in\SET{periods}(\VAR{word})$$
